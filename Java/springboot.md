...
![16.national](./image/spring/16.national.jpg)
...
![17.encoding](./image/spring/17.encoding.jpg)
...
![18.accept-language](./image/spring/18.accept-language.jpg)
...
![20.error](./image/spring/20.error.jpg)
...
![22.4xxhtml](./image/spring/22.4xxhtml.jpg)
...
![24.EmdServletFactory](./image/spring/24.EmdServletFactory.jpg)

2）、EmbeddedServletContainer:(嵌入式的Servlet容器)

![25.EmdServletContainer](./image/spring/25.EmdServletContainer.jpg)
...
![26.tomcat1](./image/spring/26.tomcat1.jpg)

2、选择版本

![27.tomcat2](./image/spring/27.tomcat2.jpg)

3、添加tomcat

![28.tomcat3](./image/spring/28.tomcat3.jpg)

4、选择tomcat

![30.tomcat4](./image/spring/30.tomcat4.jpg)

5、选择本地的Tomcat

![31.tomcat5](./image/spring/31.tomcat5.jpg)

6、配置tomcat路径

![32.tomcat6](./image/spring/32.tomcat6.jpg)

7、添加服务器

![33.tomcat7](./image/spring/33.tomcat7.jpg)

8、添加exploded的war配置，应用OK tomcat配置完成

![34.tomcat8](./image/spring/34.tomcat8.jpg)

二、配置webapp文件夹

1、点击配置

![35.tomcat9](./image/spring/35.tomcat9.jpg)

2、添加webapp目录

![36.tomcat10](./image/spring/36.tomcat10.jpg)

3、默认配置就可以

![37.tomcat11](./image/spring/37.tomcat11.jpg)

4、配置web.xml文件

![38.tomcat12](./image/spring/38.tomcat12.jpg)

5、文档目录结构

![39.tomcat13](./image/spring/39.tomcat13.jpg)

### 2、运行一个示例

1、项目目录

![40.demo1](./image/spring/40.demo1.jpg)
...
![41.demo2](./image/spring/41.demo2.jpg)
...
![42.servletContainerInit](./image/spring/42.servletContainerInit.jpg)
...
默认去docker hub网站查找![44.docker1](./image/spring/44.docker1.jpg)
...
![45.schema-all](./image/spring/45.schema-all.jpg)
...
![46.department](./image/spring/46.department.jpg)



3、访问请求查询数据

![47.hello](./image/spring/47.hello.jpg)
...
![48.druid](./image/spring/48.druid.jpg)
...
![50.mybatisxml](./image/spring/50.mybatisxml.jpg)
...
![51.JPA](./image/spring/51.JPA.jpg)
...
![52.applicationCotextInitializer](./image/spring/52.applicationCotextInitializer.jpg)

 ApplicationListener

![53.Listener](./image/spring/53.Listener.jpg)
...
![54.listener2](./image/spring/54.listener2.jpg)
...
![56.starter01](./image/spring/56.starter01.jpg)

2、项目命名

![57.starter02](./image/spring/57.starter02.jpg)



3、导入module

![58.starter03](./image/spring/58.starter03.jpg)

4、新建一个Maven工程

![59.starter04](./image/spring/59.starter04.jpg)

5、项目命名

![60.starter05](./image/spring/60.starter05.jpg)



![61.starter06](./image/spring/61.starter06.jpg)

6、在新建一个autoconfiguration类的spring

![62.starter07](./image/spring/62.starter07.jpg)

7、项目命名

![63.starter08](./image/spring/63.starter08.jpg)

8、无需导入依赖

![64.starter09](./image/spring/64.starter09.jpg)

9、next

![65.starter10](./image/spring/65.starter10.jpg)
...
![66.starter-build01](./image/spring/66.starter-build01.jpg)
...
![67.starter-build02](./image/spring/67.starter-build02.jpg)
...
![68.starter-build03](./image/spring/68.starter-build03.jpg)
...
![70.starter-build05](./image/spring/70.starter-build05.jpg)
